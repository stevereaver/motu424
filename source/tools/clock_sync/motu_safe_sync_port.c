...
#include "golden_dsp_patch.c"
    ...
    // 4. Force Mapping and Routing for Port 2
    printf("4. Configuring Port 2 specifically...\n");
    // Map Physical Port 2 to Logical Slot 0 (so our trace configs work)
    write_reg(fd, 0, 0x8348, 0x00000001); 
    // Start Port 2
    write_reg(fd, 2, 0x4, 0x2);
...
#include "golden_sequence.c"
    ...
    printf("\nDONE! If it is not green now, try Port 3.\n");
